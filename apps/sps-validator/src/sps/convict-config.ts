...
const schema = {
    ...
    reward_pool_accounts: {
        ...
        format: 'stringy-array',
        default:
            '$REWARD_POOLS_BRAWL,$REWARD_POOLS_LAND,$REWARD_POOLS_LICENSE,$VALIDATOR_REWARDS,$REWARD_POOLS_SOULKEEP,$REWARD_POOLS_MODERN,$REWARD_POOLS_WILD,$REWARD_POOLS_SURVIVAL,$UNCLAIMED_UNISWAP_REWARDS,$TOURNAMENTS_DISTRIBUTION,$SPS_STAKING_REWARDS,$REWARD_POOLS_FOCUS,$REWARD_POOLS_SEASON,$REWARD_POOLS_SURVIVAL_BRACKET',
